...
def trainValidateSegmentation(args):
    ...
    args.savedir = args.savedir + '_v7_' + args.file_root + '_iter_' + str(args.max_steps) + '_lr_' + str(args.lr) + '/'
    args.vis_dir = args.savedir + '/Vis/'

    if args.file_root == 'LEVIR':
        args.file_root = '../../dataset/LEVIR_normal/'
    elif args.file_root == 'WHU_CD':
        args.file_root = '../../dataset/WHU_CD/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="WHU_CD", help='Data directory | LEVIR | WHU_CD | DSIFN ')
