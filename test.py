...
def ValidateSegmentation(args):
    ...
    args.savedir = args.savedir + '_v7_LEVIR_iter_' + str(args.max_steps) + '_lr_' + str(args.lr) + '/'
    args.vis_dir = './Predict/' + args.file_root + '/'

    if args.file_root == 'LEVIR':
        args.file_root = '../../dataset/LEVIR_normal/'
    elif args.file_root == 'DSIFN':
        args.file_root = '../../dataset/DSIFN/'
    elif args.file_root == 'LEVIR-vis':
        args.file_root = '/home/ww/xlc/dataset/testLEVIR/'
    elif args.file_root == 'WHU-vis':
        args.file_root = '/home/ww/xlc/dataset/testWHU/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="LEVIR", help='Data directory | LEVIR | WHU | LEVIR-vis | WHU-vis ')
